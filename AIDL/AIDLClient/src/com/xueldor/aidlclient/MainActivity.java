...
import com.xueldor.aidlserver.BookManager;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		buttonRegis = (Button)findViewById(R.id.register);
...
//									System.out.println("client tid " + Process.myTid());
//									mBookManager.registerBookAddListener(callback);
//									mBookManager.registerBookAddListener(callback);//服务端callback是两个对象，但asBinder是同一个
//								} catch (RemoteException e) {
//									e.printStackTrace();
//								}
//							}
